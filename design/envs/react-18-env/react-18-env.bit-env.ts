/**
 * this env extends react-env version 0.0.65.
 * to inspect its config @see https://bit.cloud/teambit/react/react-env?version=0.0.65
 * */
...
export class React18Env extends ReactEnv {
